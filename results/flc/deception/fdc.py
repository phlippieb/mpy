from db.flc.deception import fdc_table
from results import benchmarks
from psodroc.measures import deception


def get(benchmark_name, dimensionality, experiment, verbose=False):
    """Fetch or calculate the FDC (fitness-distance correlation) for the given subject.
    ...
    Returns:
    - measurement: Float-like. The FDC measurement.
    """
...
def _fetch_existing(benchmark_name, dimensionality, experiment):
    ...
    return fdc_table.fetch(benchmark_name, dimensionality, experiment)
...
def _store(benchmark_name, dimensionality, experiment, measurement):
    ...
    """
    fdc_table.store(benchmark_name, dimensionality,
