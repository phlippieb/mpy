from db.flc.ruggedness import fem_0_1_table
...
def get(benchmark_name, dimensionality, experiment, verbose=False):
    """Fetch or calculate the FEM_0.1 (macro-ruggedness) measurement for the given subject.
    ...
    Returns:
    - measurement: Float-like. The FEM_0.1 measurement.
    """
...
def _fetch_existing(benchmark_name, dimensionality, experiment):
    ...
    return fem_0_1_table.fetch(benchmark_name, dimensionality, experiment)
...
def _store(benchmark_name, dimensionality, experiment, measurement):
    ...
    """
    fem_0_1_table.store(benchmark_name, dimensionality,
                        experiment, measurement)
    fem_0_1_table.commit()
...
def _calculate(benchmark_name, dimensionality):
    ...
    return ruggedness.FEM_0_1(f, f_min, f_max, dimensionality)
