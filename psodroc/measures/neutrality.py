...
def PN_LSN(function, domain_min, domain_max, dimensions, epsilon=1e-8, step_size_fraction=.02, verbose=False):
    ...
    for (i, starting_zone) in enumerate(starting_zones):
        if verbose:
            print '[neutrality] walk', i, '/', len(
                starting_zones), ': walking...'
