...
def _velocity(pbest_position, gbest_position):
    # In barebones PSO, the velocity of a particle is a vector sampled from a Gaussian distribution with its mean between the particle's pbest and gbest positions, and with a deviation of the distance between those two points.
